...
public class GennySettings {
    ...
    public static int MAX_KEYCLOAK_USER_PER_CALL = 500;
    ...
    public static final String videoConverterUrl = System.getenv("VIDEO_CONVERTER_SERVICE_URL") != null ? System.getenv("VIDEO_CONVERTER_SERVICE_URL") : (projectUrl + ":8080");
    ...
    public static final String defaultServiceKey = VaultUtils.readValue("ENV_SECURITY_KEY") == null ? "WubbaLubbaDubDub" : System.getenv("ENV_SECURITY_KEY");
    public static final String defaultServiceEncryptedPassword = VaultUtils.readValue("ENV_SERVICE_PASSWORD") == null ? "vRO+tCumKcZ9XbPWDcAXpU7tcSltpNpktHcgzRkxj8o=" : System.getenv("ENV_SERVICE_PASSWORD");
    ...
    public static final String emailSmtpHost = VaultUtils.readValue("EMAIL_SMTP_HOST") != null ? VaultUtils.readValue("EMAIL_SMTP_HOST") : "http://keycloak.genny.life";
    public static final String emailSmtpUser = VaultUtils.readValue("EMAIL_SMTP_USER") != null ? VaultUtils.readValue("EMAIL_SMTP_USER") : "http://keycloak.genny.life";
    public static final String emailSmtpPassword = VaultUtils.readValue("EMAIL_SMTP_PASS") != null ? VaultUtils.readValue("EMAIL_SMTP_PASS") : "http://keycloak.genny.life";
    public static final String emailSmtpPort = VaultUtils.readValue("EMAIL_SMTP_PORT") != null ? VaultUtils.readValue("EMAIL_SMTP_PORT") : "http://keycloak.genny.life";
    public static final String emailSmtpStartTls = VaultUtils.readValue("EMAIL_SMTP_STARTTLS") != null ? VaultUtils.readValue("EMAIL_SMTP_STARTTLS") : "http://keycloak.genny.life";
    public static final String emailSmtpAuth = VaultUtils.readValue("EMAIL_SMTP_AUTH") != null ? VaultUtils.readValue("EMAIL_SMTP_HOST") : "http://keycloak.genny.life";

    public static final String twilioAccountSid = VaultUtils.readValue("TWILIO_ACCOUNT_SID") != null ? VaultUtils.readValue("TWILIO_ACCOUNT_SID") : "TWILIO_ACCOUNT_SID";
    public static final String twilioAuthToken = VaultUtils.readValue("TWILIO_AUTH_TOKEN") != null ? VaultUtils.readValue("TWILIO_AUTH_TOKEN") : "TWILIO_AUTH_TOKEN";
    public static final String twilioSenderMobile = VaultUtils.readValue("TWILIO_SENDER_MOBILE") != null ? VaultUtils.readValue("TWILIO_SENDER_MOBILE") : "TWILIO_SENDER_MOBILE";
