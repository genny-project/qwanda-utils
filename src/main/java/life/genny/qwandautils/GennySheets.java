...
//		InputStream in = GennySheets.class.getResourceAsStream("/client_secret_2.json");
		InputStream in = IOUtils.toInputStream(CLIENT_SECRET, "UTF-8");
...
//		values.stream().peek(act-> System.out.println(act+"ok1")).
	...
	public static <T> List<T> getBeans(Class clazz) throws IOException {
		Sheets service = getSheetsService();
		String range = clazz.getSimpleName()+ RANGE;
	...
	public static void main() throws IOException {
	  ...
	  List<BaseEntity> bes = getBeans(BaseEntity.class);
