...
//		InputStream in = GoogleUtilsTest.class.getResourceAsStream("/client_secret_2.json");
...
//			
//	
//			Writer lll = new StringWriter();
//			lll.write("jklsdjfsjdkjfdjjjjjj");
//			String theString =  new BufferedReader(new InputStreamReader(in))
//					  .lines().collect(Collectors.joining("\n"));
//		
//			InputStream inp = IOUtils.toInputStream("ksjfklsjdkfjsjdfkjds", "UTF-8");
